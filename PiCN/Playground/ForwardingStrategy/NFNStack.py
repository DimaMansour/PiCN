...
import PiCN.Playground.ForwardingStrategy.NFNComputationLayer
...
class NFNStack(object):
    def __init__(self, replica_id, port=9500, log_level=255, encoder: BasicEncoder = NdnTlvEncoder):
        ...
        pit = synced_data_struct_factory.manager.pit(pit_timeout=3000)
        ...
        self.nfn_computation_layer = PiCN.Playground.ForwardingStrategy.NFNComputationLayer(replica_id, log_level=log_level)
