""" NFNServer Repository """

import argparse
import logging


import PiCN.Playground.ForwardingStrategy.NFNStack
...
def main(args):
    ...
    # Start
    server = PiCN.Playground.ForwardingStrategy.NFNStack(replica_id=args.id, port=args.port, log_level=log_level,
                                                      encoder=encoder)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='NFN Server')
